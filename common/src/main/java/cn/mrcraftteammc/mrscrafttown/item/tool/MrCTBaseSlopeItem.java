...
public class MrCTBaseSlopeItem extends DiggerItem {
    public MrCTBaseSlopeItem(float damage, float attackspeed, Tier tier, TagKey<Block> tagKey, int defaultDurability, int durability, Rarity rarity) {
