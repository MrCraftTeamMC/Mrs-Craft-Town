...
public class MrCTBaseScrewdriverItem extends DiggerItem {
    public MrCTBaseScrewdriverItem(float damage, float attackspeed, Tier tier, TagKey<Block> tagKey, int defaultDurability, int durability, Rarity rarity) {
