...
public class MrCTBaseHammerItem extends DiggerItem {
    public MrCTBaseHammerItem(float damage, float attackspeed, Tier tier, TagKey<Block> tagKey, int defaultDurability, int durability, Rarity rarity) {
